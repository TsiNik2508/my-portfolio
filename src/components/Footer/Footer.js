  ...
  },
  {
    ...
    svg: (
      <svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        <path d="M12 0C5.372 0 0 5.372 0 12c0 6.628 5.372 12 12 12s12-5.372 12-12c0-6.628-5.372-12-12-12zm4.643 8.604l-1.74 8.198c-.13.571-.466.709-.943.44l-2.603-1.92-1.254 1.208c-.138.138-.255.255-.52.255l.184-2.613 4.756-4.297c.207-.207-.046-.322-.322-.115l-5.871 3.688-2.525-.789c-.549-.173-.56-.549.115-.805l9.891-3.814c.443-.173.83.103.678.8z" fill="#8E2DE2" />
      </svg>
    ),
  },
  {
...
const Footer = () => {
  ...
  return (
    <footer className="footer">
      ...
      <div className="footer__center">Copyright © {year}</div>
