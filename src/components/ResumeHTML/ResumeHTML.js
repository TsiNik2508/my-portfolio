    ...
    <div className="resume-html">
      ...
      <div className="resume-html__contacts">
        ...
        <div className="resume-html__contact-item">
          ...
          <a href={`mailto:${t('resume.contacts.email')}`} className="resume-html__link">{t('resume.contacts.email')}</a>
        </div>
        <div className="resume-html__contact-item">
          <svg className="resume-html__icon" viewBox="0 0 24 24">
          ...
          <a href="https://github.com/TsiNik2508" target="_blank" rel="noopener noreferrer" className="resume-html__link">{t('resume.contacts.github')}</a>
        </div>
        <div className="resume-html__contact-item">
          <svg className="resume-html__icon" viewBox="0 0 24 24">
          ...
          <a href="https://www.linkedin.com/in/nikita-tsilosani-5367782b4/" target="_blank" rel="noopener noreferrer" className="resume-html__link">{t('resume.contacts.linkedin')}</a>
        </div>
        <div className="resume-html__contact-item">
          <svg className="resume-html__icon" viewBox="0 0 24 24">
          ...
          <a href="https://web.telegram.org/k/#@Tsi_Nick" target="_blank" rel="noopener noreferrer" className="resume-html__link">{t('resume.contacts.telegram')}</a>
        </div>
      </div>

      <section className="resume-html__section">
        <h2 className="resume-html__section-title">{t('resume.sections.experience')}</h2>
        
        <div className="resume-html__job">
          <h3 className="resume-html__company">{t('resume.jobs.diar.company')}</h3>
          <span className="resume-html__position">{t('resume.jobs.diar.position')}</span>
          <span className="resume-html__date">{t('resume.jobs.diar.date')}</span>
          <p>{t('resume.jobs.diar.description')} <a href="https://medical112.ru/" target="_blank" rel="noopener noreferrer">medical112.ru</a> {t('resume.and')} <a href="https://diar-engineering.ru/" target="_blank" rel="noopener noreferrer">diar-engineering.ru</a></p>
          <ul>
            {(t('resume.jobs.diar.tasks', { returnObjects: true }) || []).map((task, index) => (
        ...
        <div className="resume-html__job">
          <h3 className="resume-html__company">{t('resume.sections.freelance')}</h3>
          <span className="resume-html__position">{t('resume.jobs.freelance.position')}</span>
          <span className="resume-html__date">{t('resume.jobs.freelance.date')}</span>
          {(t('resume.jobs.freelance.jobs', { returnObjects: true }) || []).map((job, index) => (
      ...
      <section className="resume-html__section">
        <h2 className="resume-html__section-title">{t('resume.sections.projects')}</h2>
        {['palc', 'moviesExplorer'].map((projectKey) => {
          const project = t(`resume.projects.${projectKey}`, { returnObjects: true });
          return (
            <div key={projectKey} className="resume-html__job">
              <h3 className="resume-html__job-title">{project.title} <span className="resume-html__tech">{project.tech}</span></h3>
      ...
      <section className="resume-html__section">
        <h2 className="resume-html__section-title">{t('resume.sections.skills')}</h2>
        <p className="resume-html__text">{t('resume.skills')}</p>
      </section>

      <section className="resume-html__section">
        <h2 className="resume-html__section-title">{t('resume.sections.education')}</h2>
        <div className="resume-html__job">
          <h3 className="resume-html__job-title">{t('resume.education.yandex.institution')}</h3>
